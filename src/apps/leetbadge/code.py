...
probably best to start with images of the correct dimensions:
    ...
    magick -depth 1 -compress none -resize 264x176\! epd_logo.png /Volumes/CIRCUITPY/img/my_epd_logo.png
...
from badge.constants import BLACK, BLUE, WHITE, YELLOW, MAGENTA
...
EPD_DEFAULT_IMAGE = '/img/epd_logo.bmp'
