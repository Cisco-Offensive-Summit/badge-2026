...
static const mp_rom_map_elem_t board_module_globals_table[] = {
    ...
    // GPIO35/36/37 are consumed by the module's 8 MB octal PSRAM -- not usable.
    // (See CIRCUITPY_ESP_PSRAM_* in mpconfigboard.mk.)
    ...
    { MP_ROM_QSTR(MP_QSTR_EINK_DC),   MP_ROM_PTR(&pin_GPIO21)  },
